...
AddOutputFilter chunkFilter
		...
		<Item Name="Alter Display.vi" Type="VI" URL="../Alter Display.vi"/>
		<Item Name="Find Location.vi" Type="VI" URL="../Find Location.vi"/>
		<Item Name="Find Route.vi" Type="VI" URL="../Find Route.vi"/>
		<Item Name="GUI main.vi" Type="VI" URL="../GUI main.vi"/>
		<Item Name="IMU initialize.vi" Type="VI" URL="../IMU initialize.vi"/>
		<Item Name="IMU read.vi" Type="VI" URL="../IMU read.vi"/>
		<Item Name="Initialize System.vi" Type="VI" URL="../Initialize System.vi"/>
		<Item Name="Motor Moving.vi" Type="VI" URL="../Motor Moving.vi"/>
		<Item Name="Robot Moving.vi" Type="VI" URL="../Robot Moving.vi"/>
		<Item Name="Target Obsticle Check.vi" Type="VI" URL="../Target Obsticle Check.vi"/>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Bayer 3X3 Buffer.vi" Type="VI" URL="../../../Kinect Project/subVIs/Bayer 3X3 Buffer.vi"/>
			<Item Name="Bayer.vi" Type="VI" URL="../../../Kinect Project/subVIs/Bayer.vi"/>
			<Item Name="chose distance.vi" Type="VI" URL="../../new imu/chose distance.vi"/>
			<Item Name="Close Device (SubVI).vi" Type="VI" URL="../../../Kinect Project/subVIs/Close Device (SubVI).vi"/>
			<Item Name="Close kinect systems.vi" Type="VI" URL="../../../Kinect Project/Close kinect systems.vi"/>
			<Item Name="Control main.vi" Type="VI" URL="../../Control system for motors and imu/Control main.vi"/>
			<Item Name="Depth Format Control.ctl" Type="VI" URL="../../../Kinect Project/subVIs/Depth Format Control.ctl"/>
			<Item Name="Depth Resolution Control.ctl" Type="VI" URL="../../../Kinect Project/subVIs/Depth Resolution Control.ctl"/>
			<Item Name="Initialize kinect systems.vi" Type="VI" URL="../../../Kinect Project/Initialize kinect systems.vi"/>
			<Item Name="Kinect Shutdown.vi" Type="VI" URL="../../../Kinect Project/subVIs/Kinect Shutdown.vi"/>
			<Item Name="Kinect Video Controller.vi" Type="VI" URL="../../../Kinect Project/Kinect Video Controller.vi"/>
			<Item Name="Kinect_init(SubVI).vi" Type="VI" URL="../../../Kinect Project/subVIs/Kinect_init(SubVI).vi"/>
			<Item Name="Led Control.ctl" Type="VI" URL="../../../Kinect Project/subVIs/Led Control.ctl"/>
			<Item Name="libkinect_wrapper.dll" Type="Document" URL="libkinect_wrapper.dll">
				<Property Name="NI.PreserveRelativePath" Type="Bool">true</Property>
			</Item>
			<Item Name="Log Level Control.ctl" Type="VI" URL="../../../Kinect Project/subVIs/Log Level Control.ctl"/>
			<Item Name="maintarget.vi" Type="VI" URL="../../../../../maintarget.vi"/>
			<Item Name="new imu.vi" Type="VI" URL="../../new imu/new imu.vi"/>
			...
			<Item Name="Open Device.vi" Type="VI" URL="../../../Kinect Project/subVIs/Open Device.vi"/>
			<Item Name="Read Video.vi" Type="VI" URL="../../../Kinect Project/subVIs/Read Video.vi"/>
			<Item Name="Set Led(SubVI).vi" Type="VI" URL="../../../Kinect Project/subVIs/Set Led(SubVI).vi"/>
			<Item Name="Set Tilt Degree (SubVI).vi" Type="VI" URL="../../../Kinect Project/subVIs/Set Tilt Degree (SubVI).vi"/>
			<Item Name="Start Depth.vi" Type="VI" URL="../../../Kinect Project/subVIs/Start Depth.vi"/>
			<Item Name="Start Video.vi" Type="VI" URL="../../../Kinect Project/subVIs/Start Video.vi"/>
			<Item Name="Stop Depth.vi" Type="VI" URL="../../../Kinect Project/subVIs/Stop Depth.vi"/>
			<Item Name="Stop Video.vi" Type="VI" URL="../../../Kinect Project/subVIs/Stop Video.vi"/>
			<Item Name="Video Format Control.ctl" Type="VI" URL="../../../Kinect Project/subVIs/Video Format Control.ctl"/>
			<Item Name="Video Resolution Control.ctl" Type="VI" URL="../../../Kinect Project/subVIs/Video Resolution Control.ctl"/>

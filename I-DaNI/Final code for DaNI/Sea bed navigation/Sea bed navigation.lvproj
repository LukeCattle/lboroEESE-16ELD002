...
AddOutputFilter chunkFilter
		...
		<Item Name="Kinect Project" Type="Folder" URL="../../../Labview/Kinect Project/Kinect Project">
			<Property Name="NI.DISK" Type="Bool">true</Property>
		</Item>
		<Item Name="Sub VI" Type="Folder">
			<Item Name="Choose location.vi" Type="VI" URL="../Choose location.vi"/>
			<Item Name="Choose route.vi" Type="VI" URL="../Choose route.vi"/>
			<Item Name="correct angle.vi" Type="VI" URL="../correct angle.vi"/>
			<Item Name="forward+backward.vi" Type="VI" URL="../forward+backward.vi"/>
			<Item Name="Improved find target.vi" Type="VI" URL="../Improved find target.vi"/>
			<Item Name="Initialize IMU.vi" Type="VI" URL="../Initialize IMU.vi"/>
			<Item Name="Inizialize map.vi" Type="VI" URL="../Inizialize map.vi"/>
			<Item Name="LED control.vi" Type="VI" URL="../LED control.vi"/>
			<Item Name="Read IMU.vi" Type="VI" URL="../Read IMU.vi"/>
			<Item Name="Reset IMU.vi" Type="VI" URL="../Reset IMU.vi"/>
			<Item Name="Turn DaNI.vi" Type="VI" URL="../Turn DaNI.vi"/>
			<Item Name="turning.vi" Type="VI" URL="../turning.vi"/>
			<Item Name="Update Hazards.vi" Type="VI" URL="../Update Hazards.vi"/>
			<Item Name="Update obsticles.vi" Type="VI" URL="../Update obsticles.vi"/>
			<Item Name="Update robot location and direction.vi" Type="VI" URL="../Update robot location and direction.vi"/>
			<Item Name="Update route + target location.vi" Type="VI" URL="../Update route + target location.vi"/>
			<Item Name="Validate hazard.vi" Type="VI" URL="../Validate hazard.vi"/>
		</Item>
		<Item Name="clear map.vi" Type="VI" URL="../clear map.vi"/>
		<Item Name="correct map.vi" Type="VI" URL="../correct map.vi"/>
		<Item Name="create map.vi" Type="VI" URL="../create map.vi"/>
		<Item Name="Execute Route.vi" Type="VI" URL="../Execute Route.vi"/>
		<Item Name="Find choosen target.vi" Type="VI" URL="../Find choosen target.vi"/>
		<Item Name="Find Route.vi" Type="VI" URL="../Find Route.vi"/>
		<Item Name="GUI.vi" Type="VI" URL="../GUI.vi"/>
		<Item Name="Initialize map bearings.vi" Type="VI" URL="../Initialize map bearings.vi"/>
		<Item Name="load data.vi" Type="VI" URL="../load data.vi"/>
		<Item Name="Reset DaNI Direction.vi" Type="VI" URL="../Reset DaNI Direction.vi"/>
		<Item Name="Save data.vi" Type="VI" URL="../Save data.vi"/>
		<Item Name="Scan for hazards.vi" Type="VI" URL="../Scan for hazards.vi"/>
		<Item Name="Scan for obsticles.vi" Type="VI" URL="../Scan for obsticles.vi"/>
		<Item Name="Turning control.vi" Type="VI" URL="../Turning control.vi"/>
